...
let MissionService = class MissionService {
    ...
    async getMissionsByDepartment(department) {
        return await this.missionRepository.find({
            where: {
                firedepartments: (0, typeorm_2.Like)(`%${department}%`)
            }
        });
    }
...
MissionService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(mission_repository_1.MissionRepository)),
