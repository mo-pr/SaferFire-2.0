        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            NumberPicker(
              ...
              onChanged: (value) =>
                  setState(() => personenGebaeude = value),
            ...
            SizedBox(height: 20),
            Text('aus Kraftfahrzeugen gerettet', style: Theme.of(context).textTheme.headline6),
            SizedBox(height: 6),
            NumberPicker(
            ...
            SizedBox(height: 20),
            Text('verletzt gerettet', style: Theme.of(context).textTheme.headline6),
            SizedBox(height: 6),
            NumberPicker(
              ...
              axis: Axis.horizontal,
              onChanged: (value) =>
                  setState(() => personenVerletzt = value),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: Colors.black26),
              ),
            ...
            ElevatedButton(
              ...
              onPressed: (){
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => _Brand_TiereGerettet(protocol: widget.protocol))
                );
              },
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              onPressed: (){
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => _Brand_Statistik(protocol: widget.protocol))
                );
